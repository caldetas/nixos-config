...
#
#   https://github.com/vpsfreecz/vpsadminos/blob/staging/os/lib/nixos-container/vpsa
dminos.nix
  ...
  in
  {
    ...
    boot.systemdExecutable = mkDefault "/run/current-system/systemd/lib/systemd/system
d systemd.unified_cgroup_hierarchy=0";
    console.enable = true;
